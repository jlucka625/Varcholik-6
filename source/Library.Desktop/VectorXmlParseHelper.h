...
namespace LibraryDesktop
{
	...
	{
	public:
		/** @brief					Default constructor for the VectorXmlParseHelper derived class.
		*   @return                 Instance of the VectorXmlParseHelper derived class.
		*/
		explicit VectorXmlParseHelper();

		VectorXmlParseHelper(const VectorXmlParseHelper& otherSharedData) = delete;

		VectorXmlParseHelper& operator=(const VectorXmlParseHelper& otherSharedData) = delete;

		/** @brief					Default destructor for the VectorXmlParseHelper derived class.
		*
		*/
		virtual ~VectorXmlParseHelper() = default;
		...
		*/
		...
		/** @brief					Produces a new instance of the VectorXmlParseHelper class.
		*   @return					Heap-allocated instance of the VectorXmlParseHelper class.
		*/
	...
	private:
		...
		static const std::string VECTOR_TAG;
	};
}
