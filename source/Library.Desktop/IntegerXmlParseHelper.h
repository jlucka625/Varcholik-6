...
namespace LibraryDesktop
{
	...
	{
	public:
		/** @brief					Default constructor for the IntegerXmlParseHelper derived class.
		*   @return                 Instance of the IntegerXmlParseHelper derived class.
		*/
		explicit IntegerXmlParseHelper();

		IntegerXmlParseHelper(const IntegerXmlParseHelper& otherSharedData) = delete;

		IntegerXmlParseHelper& operator=(const IntegerXmlParseHelper& otherSharedData) = delete;

		/** @brief					Default destructor for the IntegerXmlParseHelper derived class.
		*
		*/
		virtual ~IntegerXmlParseHelper() = default;
	...
	private:
		...
		static const std::string INTEGER_TAG;
	};
}
