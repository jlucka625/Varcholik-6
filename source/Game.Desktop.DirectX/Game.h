...
namespace Library
{
	...
	public:
		...
		//Used when the sprites load textures
		static HashMap<std::string, std::string> textureLookups;
		static HashMap<std::string, glm::vec2> textureFrameLookups;
	...
	protected:
		...
		LibraryDesktop::GameTime mGameTime;
		...
		EntityInputHandler* mInputHandler;
		Keyboard* mKeyboard;
